...
module "deployer_permission_set" {
  source = "git::https://github.com/bloom-housing/bloom.git//infra/tofu_importable_modules/bloom_deployer_permission_set_policy?ref=28ca3ef182c30936ca28821be021c85b58082daf"
